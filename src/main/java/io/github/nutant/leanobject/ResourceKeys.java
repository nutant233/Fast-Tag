...
public final class ResourceKeys {
    ...
    public static final WeakValueHashCache<ResourceLocation, ResourceKey> ROOT_REGISTRY_MAP = RESOURCE_LOCATION_TO_RESOURCEKEY_INTERNING_MAP.getCache(Registries.ROOT_REGISTRY_NAME);
